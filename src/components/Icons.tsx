...
export function CompassIcon({ filled, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <polygon
        points="16.5 7.5 14 14 7.5 16.5 10 10"
        fill={filled ? "currentColor" : "none"}
      />
    </svg>
  );
...
export function PlusSquareIcon({ filled, ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill={filled ? "currentColor" : "none"}
    ...
    >
      ...
      <line x1="12" y1="8" x2="12" y2="16" stroke={filled ? "#0a0a0b" : "currentColor"} />
      <line x1="8" y1="12" x2="16" y2="12" stroke={filled ? "#0a0a0b" : "currentColor"} />
    </svg>
  );
}
